...
export class ShopPlPage {
  ...
  constructor(page: Page) {
    ...
    this.removeButton = page.getByRole('button', { name: 'Usuń produkt' });
  ...
  async navigate() {
    ...
    await this.page
      ...
      .click();
    await this.page.getByRole('button', { name: 'Potwierdź' }).click();
    await this.page
      .getByTestId('header')
      .getByRole('link', { name: 'Sklep' })
      .click();
    await this.closeShopMenu.click();
  }
